          ...
          <div className="mt-3 flex flex-col justify-between gap-6 md:flex-row md:items-end">
            <div>
              ...
              <p className="mt-4 max-w-2xl leading-7 text-gray-600">
                Explore traditional medicinal plants and discover their uses,
                habitats, cultivation methods, and regions.
              </p>
            </div>
          ...
          <div className="grid gap-4 md:grid-cols-[1fr_220px_auto]">
            ...
            <div>
              ...
              >
                ...
                <option value="Succulent Herb">Succulent Herb</option>
                <option value="Climbing Herb">Climbing Herb</option>
              </select>
            </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-10">
        ...
        {!loading && !error && plants.length === 0 && (
          <div className="rounded-2xl border border-green-100 bg-white py-20 text-center">
            <p className="text-lg font-medium text-gray-800">No plants found</p>
